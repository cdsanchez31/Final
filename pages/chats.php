...
<head>
    ...
    <?php
    $chats = mysqli_query("SELECT * FROM rchats WHERE De = '".$_SESSION['idUsuario']."' OR Para = '".$_SESSION['idUsuario']."' order by IdRChat desc");
    ...
    $us = mysql_fetchi_array($usere);

    $chat = mysqli_query("SELECT * FROM chat WHERE IdRChat = '".$ch['idRChat']."' ORDER BY IdChat desc limit 1");
    $cha = mysqli_fetch_array($chat);

    ?>
    <tr>
    <td class="mailbox-star">
    <?php if($cha['lecturaMensaje'] == 0) { ?>
