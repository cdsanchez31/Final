...
<head>
  ...
  <title>MaterialAdminLTE 2 | Mailbox</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-raised btn-block margin-bottom">Compose</a>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                <!-- Check all button -->
                <div class="btn-group checkbox check-all"><label><input type="checkbox" class="checkbox-toggle"></label></div>
                <div class="btn-group">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail.html">Thanh Nguyen</a></td>
                    <td class="mailbox-subject"><b>AdminLTE 2.4 Issue</b> - Trying to find a solution to this problem...
                    </td>
